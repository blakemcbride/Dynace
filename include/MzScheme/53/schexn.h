...
enum {
  ...
  MZEXN_APPLICATION_MACOS_TYPESTRING,
  MZEXN_ELSE,
  MZEXN_STRUCT,
...
static exn_rec *exn_table;
  ...
  exn_table[MZEXN_APPLICATION_MACOS_TYPESTRING].args = 3;
  ...
  exn_table[MZEXN_MISC_SEND_EVENT].args = 2;
...
static const char *MZEXN_MISC_IMAGE_FIELDS[1] = { "name" };
  ...
  SETUP_STRUCT(MZEXN_APPLICATION_MACOS_TYPESTRING, EXN_PARENT(MZEXN_APPLICATION), "exn:application:macos-typestring", 0, NULL)
  ...
  SETUP_STRUCT(MZEXN_MISC_SEND_EVENT, EXN_PARENT(MZEXN_MISC), "exn:misc:send-event", 0, NULL)

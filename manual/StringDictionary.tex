...
key/value pair in the @code{StringDictionary} instance (@code{i}).
...
@code{StringAssociation} will be added and returned which represents the
key/value pair of @code{key} and @code{value}.
@c @example
@c @group
@c @exdent Example:
@c 

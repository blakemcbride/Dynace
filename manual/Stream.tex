...
which possess the ability to read and write characters sequentially.
...
@end group
@end example
This method is used to obtain the total length of the @code{Stream} represented
by @code{i}.
@c @example
@c @group
@c @exdent Example:
...
@end group
@end example
This method is used to obtain the current position in the stream
...
The value returned is the actual position sought, or 0 on error.
@c @example
@c @group
@c @exdent Example:
@c  

...
superclass of your instance, you would use the following syntax.
...
Note that both classes' print methods share the same generic function,
@code{gPrint}.
...
argument checking turned on must agree with all methods with which they are
...
and abort the program.  Otherwise, the continuation of the program could wreak
...
time; you must use one or the other.  When using the Boehm GC, there is no need to

...
This may be overridden via @code{gSetFunction::BTree}.
...
points to @code{NULL} then the first key / value pair is retrieved.  If
...
points to @code{NULL} then the last key / value pair is retrieved.  If
none is found @code{NULL} is returned.

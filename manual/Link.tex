...
The instance methods associated with the @code{Link} class are used to
...
to or @code{NULL}.  This method does not affect the instance pointed to
by @code{nxt}.
...
pointed to or @code{NULL}.  This method does not affect the instance
...
addition to affecting link @code{i}, it also affects the pointers
